<?php
  ...
  <head>
    <title>Quản lý</title>  
    <script src="admin_app_script.js"></script>
    <link rel="stylesheet" type="text/css" href="style.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
  </head>
  <!-------------------------------------- Ui come here---------------------------------------------->
  <body onload="onMenuSelected(4)">
    <div class="headernav">
    ...
    <div class="page">
      <div class="left-bar">
        <div class="menu">
          ...
          <label id="lb_notification" onclick="onMenuSelected(6)">THÔNG BÁO</label>
          <label id="lb_user" onclick="onMenuSelected(5)">NGƯỜI DÙNG</label>
          <label id="lb_caidat" onclick="onMenuSelected(2)">CÀI ĐẶT</label>
         <!--
